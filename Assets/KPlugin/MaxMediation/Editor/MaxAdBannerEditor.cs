...
{
	[CustomEditor(typeof(MaxAdBanner))]
	public class MaxAdBannerEditor : UnityEditor.Editor
	{
		#region Properties
		...
		public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(propertyBackgroundColor, new GUIContent("Background Color"));
		...
		private void Init()
		{
            ...
            propertyBackgroundColor = serializedObject.FindProperty("backgroundColor");
