...
{
    public class MaxSettingIdEditor
    {
        #region Properties
        private const string TEST_AD_ANDROID_APP_OPEN_ID = "ca-app-pub-3940256099942544/9257395921",
            ...
            TEST_AD_ANDROID_MRECT = "ca-app-pub-3940256099942544/5354046379",
        ...
        private const string TEST_AD_IOS_APP_OPEN_ID = "ca-app-pub-3940256099942544/5575463023",
            ...
            TEST_AD_IOS_MRECT_ID = "ca-app-pub-3940256099942544/6978759866",
        ...
        private MaxAdType adType;
        private bool isShow;
        #endregion

        #region Construction
        public MaxSettingIdEditor(SerializedProperty propertyAds, MaxAdType adType)
        {
