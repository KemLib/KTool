...
namespace KPlugin.AdMob.Editor
{
    public class GoogleAdMobSettingEditor
    {
        ...
        private SerializedProperty propertyAdMobAndroidAppId,
            ...
            propertyDelayAppMeasurementInit,
        ...
        private void OnGUI_PropertyGoogleAdMob()
        {
            ...
            GUILayout.EndHorizontal();
            //
            EditorGUILayout.PropertyField(propertyDelayAppMeasurementInit, new GUIContent("Delay App Measurement Init"));
        ...
        private void SettingObject_Load()
        {
            ...
            if (scriptable == null)
            {
                ...
                propertyDelayAppMeasurementInit = null;
            ...
            propertyDelayAppMeasurementInit = serializedGoogleAdMob.FindProperty("delayAppMeasurementInit");
