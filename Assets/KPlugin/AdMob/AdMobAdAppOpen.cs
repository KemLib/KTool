...
{
    public class AdMobAdAppOpen : AdMobAd, IAdAppOpen
    {
        #region Properties
        private const int AD_EXPIRE_HOUR = 1;

        [SerializeField]
        [SelectAdId(AdMobAdType.AppOpen)]
        ...
        private void Ad_OnLoadComplete(AppOpenAd adObject, LoadAdError error)
        {
            if (error != null || adObject == null)
            {
                ...
                //
                PushEvent_OnAdCreated(AdMobAdType.AppOpen, false);
                return;
            }
            //
            attemptLoad = 0;
            ...
            Ad_EventRegister();
            //
            PushEvent_OnAdCreated(AdMobAdType.AppOpen, true);
            PushEvent_OnAdLoaded(AdMobAdType.AppOpen, true);
        }
        ...
        {
            PushEvent_OnAdDisplayed(AdMobAdType.AppOpen, true);
        }
        private void Ad_OnAdFullScreenContentFailed(AdError adError)
        {
            ...
            //
            PushEvent_OnAdDisplayed(AdMobAdType.AppOpen, false);
            //
            Ad_Destroy();
            if (IsAutoReload)
                Ad_Create();
        ...
        private void Ad_OnAdClicked()
        {
            ...
            //
            PushEvent_OnAdClicked(AdMobAdType.AppOpen);
        }
        private void Ad_OnAdFullScreenContentClosed()
        {
            ...
            //
            PushEvent_OnAdHidden(AdMobAdType.AppOpen);
            //
            Ad_Destroy();
            if (IsAutoReload)
                Ad_Create();
        ...
        private void Ad_OnAdPaid(AdValue adValue)
        {
            ...
            PushEvent_OnAdRevenuePaid(AdMobAdType.AppOpen, revenuePaid);
        }
