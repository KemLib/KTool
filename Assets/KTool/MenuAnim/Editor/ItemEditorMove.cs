...
{
    public class ItemEditorMove : ItemEditor
    {
        #region Properties
        ...
        #region Construction
        public ItemEditorMove(SerializedProperty propertyItem) : base(propertyItem)
        {
        ...
        protected override void OnGui_Chil()
        {
            ...
            if (EditorGUI.EndChangeCheck() && propertyRtfObject.objectReferenceValue != null)
            {
                ...
                propertyTaget.vector2Value = rtfObject.anchoredPosition;
            }
        ...
        public override void SetStateTaget()
        {
            ...
            {
                case RtfType.XY:
                    rtf.anchoredPosition = propertyTaget.vector2Value;
                    break;
                case RtfType.X:
                    rtf.anchoredPosition = new Vector2(propertyTaget.vector2Value.x, rtf.anchoredPosition.y);
                    break;
                case RtfType.Y:
                    rtf.anchoredPosition = new Vector2(rtf.anchoredPosition.x, propertyTaget.vector2Value.y);
                    break;
            }
        }
        #endregion Method
