...
{
    public class ItemEditorResize : ItemEditor
    {
        #region Properties
        ...
        #region Construction
        public ItemEditorResize(SerializedProperty propertyItem) : base(propertyItem)
        {
        ...
        protected override void OnGui_Chil()
        {
            ...
            if (EditorGUI.EndChangeCheck() && propertyRtfObject.objectReferenceValue != null)
            {
                ...
                propertyTaget.vector2Value = rtfObject.sizeDelta;
            }
        ...
        public override void SetStateTaget()
        {
            ...
            {
                case RtfType.XY:
                    rtf.sizeDelta = propertyTaget.vector2Value;
                    break;
                case RtfType.X:
                    rtf.sizeDelta = new Vector2(propertyTaget.vector2Value.x, rtf.sizeDelta.y);
                    break;
                case RtfType.Y:
                    rtf.sizeDelta = new Vector2(rtf.sizeDelta.x, propertyTaget.vector2Value.y);
                    break;
            }
        }
        #endregion Method
