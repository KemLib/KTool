...
{
    public class ItemEditorColorAlpha : ItemEditor
    {
        #region Properties
        ...
        #region Construction
        public ItemEditorColorAlpha(SerializedProperty propertyItem) : base(propertyItem)
        {
        ...
        protected override void OnGui_Chil()
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                propertyTaget.floatValue = graphic.color.a;
            }
        ...
        public override void SetStateTaget()
        {
            if (propertyGraphic.objectReferenceValue == null)
                return;
            MaskableGraphic graphic = propertyGraphic.objectReferenceValue as MaskableGraphic;
            graphic.color = new Color(graphic.color.r, graphic.color.g, graphic.color.b, propertyTaget.floatValue);
        }
        #endregion Method
    }
}
