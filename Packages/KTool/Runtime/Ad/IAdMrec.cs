...
namespace KTool.Ad
{
    public interface IAdMRec : IAd
    {
        #region Properties
        public static IAdMRec Instance => AdManager.Instance.Get<IAdMRec>(0);
        ...
        #region Instance
        static AdType Instance_AdType => (Instance == null ? AdType.MRec : Instance.AdType);
