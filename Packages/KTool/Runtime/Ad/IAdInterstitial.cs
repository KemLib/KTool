namespace KTool.Ad
{
    public interface IAdInterstitial : IAd
    {
        #region Properties
        public static IAdInterstitial Instance => AdManager.Instance.Get<IAdInterstitial>(0);
        ...
        #region Instance
        static AdType Instance_AdType => (Instance == null ? AdType.Interstitial : Instance.AdType);
